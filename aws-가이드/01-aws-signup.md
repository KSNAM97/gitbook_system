...
![AWS 프리 티어 소개 페이지 - 신규 고객 최대 200달러 크레딧, 무료/유료 플랜 비교](../aws/assets/aws-freetier-landing-page.png)
...
![AWS 가입 폼 - AWS 계정 이메일 주소와 AWS 계정 이름 입력란, 이메일 주소 확인 버튼](../aws/assets/aws-signup-email-form.png)
...
![이메일 인증 완료 메시지와 AWS 계정 암호·암호 확인 입력란, 계속(1/5단계) 버튼](../aws/assets/aws-signup-password-creation.png)
...
![계정 플랜 선택 화면 - 무료(6개월) 카드와 유료 카드 비교, 각각 무료 플랜 선택·유료 플랜 선택 버튼](../aws/assets/aws-signup-plan-selection.png)

## 4단계: 연락처 정보 입력

전체 이름, 국가 코드·전화번호, 국가, 주소, 시/우편번호 등을 입력하고 AWS 이용계약 동의 체크박스를 선택한다.

![연락처 정보 입력 폼 - 전체 이름, 조직 이름(선택), 전화번호, 국가, 주소, 우편번호, 이용계약 동의 체크박스, 동의 후 계속(2/5단계) 버튼](../aws/assets/aws-signup-contact-info.png)
...
![결제 정보 입력 화면 - 청구 국가, 신용카드 번호, 만료 날짜, 보안 코드, 카드 소유자 이름, 청구지 주소 입력란과 안내 문구](../aws/assets/aws-signup-payment-info.png)

## 6단계: 가입 완료

결제 정보까지 등록하면 "축하합니다! AWS에 가입해 주셔서 감사합니다" 화면과 함께 계정 활성화가 시작된다. 활성화는 보통 몇 분 안에 끝나고, 완료되면 이메일로 안내가 온다.

![가입 완료 화면 - 축하합니다 문구, AWS Management Console로 이동 버튼, 소식 수신 동의 체크박스와 제출 버튼](../aws/assets/aws-signup-complete.png)
