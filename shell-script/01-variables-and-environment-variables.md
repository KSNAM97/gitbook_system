...
### Step 5. PATH / HOME 등 주요 환경 변수 조작
...
- **해결:**
  ...
  ```
   사전에 `echo $PATH` 로 원본 값을 반드시 백업해 두어야 복구할 수 있다. PATH 변경 실습은 테스트 환경에서만 진행할 것.
